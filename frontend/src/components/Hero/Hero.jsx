...
const Hero = () => {
  ...
  return (
    <div className="relative max-w-[1280px] lg:pt-12 md:px-10 mx-auto pt-1">
      <div className="flex">
        ...
        <div className="absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12">
              ...
              <div className="flex items-center p-3 px-5">
                ...
                <div className="md:pr-5 pr-3 md:mr-2 md:pl-2">
                  ...
                  <div className="text-neutral-500 max-md:text-[14px] text-[16px]">
                    Your Business Analyst Assistant
                  </div>
                </div>
          ...
          <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 max-md:mb-5 text-[42px] md:text-[64px] max-sm:leading-[60px] max-md:leading-[70px] lg:text-[70px] font-semibold text-white">
            Leveraging the AI&nbsp;here
          </h1>
          <p className="relative z-1 text-[24px] md:text-[28px] lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12 lg:w-9/12 text-[#7d8590]">
            Made for productivity. Designed for collaboration. Celebrated for
          ...
          <div className="md:my-32 my-24">
            <p className="text-[16px] leading-[24px] text-[#7d8590]">
              Trusted by the users&nbsp; all over the world&nbsp;↘︎
            </p>
